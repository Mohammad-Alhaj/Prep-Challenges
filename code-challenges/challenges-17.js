...
console.log(see)
console.log(see.join(''))
console.log(see.reverse().join(''))


if((see.join(''))===(see.reverse().join('')))
{
...
// resources method of solution     https://www.freecodecamp.org/news/two-ways-to-check-for-palindromes-in-javascript-64fea8191fd7/
//could solve this problem by Rejex method 
}
